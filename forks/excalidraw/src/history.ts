...
class History {
	...
	private hydrateHistoryEntry({ appState, elements }: DehydratedHistoryEntry): HistoryEntry {
		return {
	...
	private dehydrateHistoryEntry({ appState, elements }: HistoryEntry): DehydratedHistoryEntry {
		return {
