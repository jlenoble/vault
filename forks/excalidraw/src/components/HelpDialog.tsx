...
const ShortcutKey = (props: { children: React.ReactNode }) => <kbd className="HelpDialog__key" {...props} />;
			...
			<Dialog onCloseRequest={handleClose} title={t("helpDialog.title")} className={"HelpDialog"}>
				...
				<Section title={t("helpDialog.shortcuts")}>
					...
					<ShortcutIsland className="HelpDialog__island--editor" caption={t("helpDialog.editor")}>
						<Shortcut
							...
							isOr={true}
						/>
						<Shortcut label={t("buttons.clearReset")} shortcuts={[getShortcutKey("CtrlOrCmd+Delete")]} />
                ...
                show users what they can do in the error message */}
						...
						<Shortcut
							...
							shortcuts={[isDarwin ? getShortcutKey("CtrlOrCmd+Alt+[") : getShortcutKey("CtrlOrCmd+Shift+[")]}
						/>
						<Shortcut
						...
						<Shortcut
							...
							shortcuts={[getShortcutKey("CtrlOrCmd+D"), getShortcutKey(`Alt+${t("helpDialog.drag")}`)]}
						/>
						<Shortcut
