...
const parseMermaidToExcalidrawSpy = vi.spyOn(MermaidToExcalidraw, "parseMermaidToExcalidraw");

parseMermaidToExcalidrawSpy.mockImplementation(
	async (definition: string, options?: MermaidToExcalidraw.MermaidOptions | undefined) => {
...
describe("Test <MermaidToExcalidraw/>", () => {
    ...
    `);
		...
		expect(dialog.querySelector('[data-testid="mermaid-error"]')).toMatchInlineSnapshot(`
        <div
          class="mermaid-error"
