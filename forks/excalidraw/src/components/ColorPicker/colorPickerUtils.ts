...
import { ColorPickerColor, ColorPaletteCustom, MAX_CUSTOM_COLORS_USED_IN_CANVAS } from "../../colors";
...
export const isCustomColor = ({ color, palette }: { color: string; palette: ColorPaletteCustom }) => {
