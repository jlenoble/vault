...
export const translationOrthogonal = (direction: Direction, distance: number): Transform => {
...
export const compose = (motor1: Transform, motor2: Transform): Transform => GA.mul(motor2, motor1);

export const apply = (motor: Transform, nvector: Point | Direction | Line): Point | Direction | Line =>
