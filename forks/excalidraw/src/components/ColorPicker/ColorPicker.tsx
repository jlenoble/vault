...
import { activeColorPickerSectionAtom, ColorPickerType } from "./colorPickerUtils";
...
const ColorPickerPopupContent = ({
	...
	ColorPickerProps,
	"type" | "color" | "onChange" | "label" | "elements" | "palette" | "updateData"
>) => {
	...
	const focusPickerContent = () => {
		popoverRef.current?.querySelector<HTMLDivElement>(".color-picker-content")?.focus();
	};
