...
import { decryptData, generateEncryptionKey, IV_LENGTH_BYTES } from "../../src/data/encryption";
...
import { AppState, BinaryFileData, BinaryFiles, UserIdleState } from "../../src/types";
...
export const getCollabServer = async (): Promise<{
	...
	try {
		const resp = await fetch(`${import.meta.env.VITE_APP_PORTAL_URL}/collab-server`);
