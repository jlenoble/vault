...
export const exportToExcalidrawPlus = async (
	...
	window.open(`${import.meta.env.VITE_APP_PLUS_APP}/import?excalidraw=${id},${encryptionKey}`);
};
...
export const ExportToExcalidrawPlus: React.FC<{
	...
	return (
		<Card color="primary">
			...
			<h2>Excalidraw+</h2>
			<div className="Card-details">{t("exportDialog.excalidrawplus_description")}</div>
			<ToolButton
