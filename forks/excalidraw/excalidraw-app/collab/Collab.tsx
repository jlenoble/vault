...
import { ExcalidrawElement, InitializedExcalidrawImageElement } from "../../src/element/types";
import { getSceneVersion, restoreElements } from "../../src/packages/excalidraw/index";
import { Collaborator, Gesture } from "../../src/types";
import { preventUnload, resolvablePromise, withBatchedUpdates } from "../../src/utils";
import {
	CURSOR_SYNC_TIMEOUT,
...
import { isImageElement, isInitializedImageElement } from "../../src/element/typeChecks";
	...
	render() {
		...
		return (
			<>
				...
				{errorMessage && (
					<ErrorDialog onClose={() => this.setState({ errorMessage: "" })}>{errorMessage}</ErrorDialog>
				)}
			</>
		);
	}
