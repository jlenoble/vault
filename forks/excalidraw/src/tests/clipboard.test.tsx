...
import { getDefaultLineHeight, getLineHeightInPx } from "../element/textElement";
...
describe("Paste bound text container", () => {
	...
	const textElement = {
		...
		originalText: "Excalidraw is a virtual opensource whiteboard for sketching hand-drawn like diagrams",
	};
