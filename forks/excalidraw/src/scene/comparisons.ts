...
import { ExcalidrawEmbeddableElement, NonDeletedExcalidrawElement } from "../element/types";
...
export const hasStrokeColor = (type: string) => type !== "image" && type !== "frame";
...
export const canChangeRoundness = (type: string) =>
	type === "rectangle" || type === "embeddable" || type === "arrow" || type === "line" || type === "diamond";
