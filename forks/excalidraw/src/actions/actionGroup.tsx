...
import { ExcalidrawElement, ExcalidrawFrameElement, ExcalidrawTextElement } from "../element/types";
...
export const actionUngroup = register({
	...
	perform: (elements, appState, _, app) => {
		...
		const frames = selectedElements
			...
			.map((element) => app.scene.getElement(element.frameId!)) as ExcalidrawFrameElement[];
