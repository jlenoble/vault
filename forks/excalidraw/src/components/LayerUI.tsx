										...
										>
											...
											>
												...
												<Stack.Row gap={1}>
													...
													<ShapesSwitcher appState={appState} activeTool={appState.activeTool} app={app} />
												</Stack.Row>
											</Island>
											{isCollaborating && (
												<Island
	...
	const layerUIJSX = (
        ...
        have defaults when host do not render anything. */}
			...
			{appState.errorMessage && (
				<ErrorDialog onClose={() => setAppState({ errorMessage: null })}>{appState.errorMessage}</ErrorDialog>
			)}
