...
): NonDeleted<ExcalidrawGenericElement> => _newElementBase<ExcalidrawGenericElement>(opts.type, opts);
...
export const refreshTextDimensions = (textElement: ExcalidrawTextElement, text = textElement.text) => {
...
export const duplicateElements = (
	...
	const elementNewIdsMap = new Map</* orig */ ExcalidrawElement["id"], /* new */ ExcalidrawElement["id"]>();
