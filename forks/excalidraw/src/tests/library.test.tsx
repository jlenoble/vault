...
describe("library", () => {
	...
	it("import library via drag&drop", async () => {
		...
		await API.drop(await API.loadFile("./fixtures/fixture_library.excalidrawlib"));
		await waitFor(async () => {
			expect(await h.app.library.getLatestLibrary()).toEqual([
				{
					status: "unpublished",
...
describe("library menu", () => {
	it("should load library from file picker", async () => {
		...
		fireEvent.click(queryByTestId(container.querySelector(".layer-ui__library")!, "dropdown-menu-button")!);
