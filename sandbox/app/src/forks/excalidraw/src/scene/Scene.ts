...
import { getNonDeletedElements, getNonDeletedFrames, isNonDeletedElement } from "../element";
...
const hashSelectionOpts = (opts: Parameters<InstanceType<typeof Scene>["getSelectedElements"]>[0]) => {
	...
	type _ = Assert<SameType<Required<HashableKeys>, Pick<Required<HashableKeys>, (typeof keys)[number]>>>;
...
class Scene {
	...
	replaceAllElements(nextElements: readonly ExcalidrawElement[], mapElementIds = true) {
