...
export const LibraryMenuContent = ({
	...
	const _onAddToLibrary = useCallback(
		(elements: LibraryItem["elements"]) => {
			const addToLibrary = async (processedElements: LibraryItem["elements"], libraryItems: LibraryItems) => {
...
const usePendingElementsMemo = (appState: UIAppState, elements: readonly NonDeletedExcalidrawElement[]) => {
	const create = () =>
	...
	if (
		!isShallowEqual(appState.selectedElementIds, prevAppState.current.selectedElementIds) ||
