...
export const getLockedLinearCursorAlignSize = (originX: number, originY: number, x: number, y: number) => {
	let width = x - originX;
...
export const resizePerfectLineForNWHandler = (element: ExcalidrawElement, x: number, y: number) => {
