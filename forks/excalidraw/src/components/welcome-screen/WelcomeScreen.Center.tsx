...
const WelcomeScreenMenuItem = ({
	...
	return (
		<button {...props} type="button" className={`welcome-screen-menu-item ${className}`} onClick={onSelect}>
...
const Heading = ({ children }: { children: React.ReactNode }) => {
	return <div className="welcome-screen-center__heading welcome-screen-decor virgil">{children}</div>;
};
