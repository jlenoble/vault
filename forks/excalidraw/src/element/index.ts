...
export const getNonDeletedFrames = (frames: readonly ExcalidrawFrameElement[]) =>
	frames.filter((frame) => !frame.isDeleted) as readonly NonDeleted<ExcalidrawFrameElement>[];
...
export const clearElementsForLocalStorage = (elements: readonly ExcalidrawElement[]) =>
