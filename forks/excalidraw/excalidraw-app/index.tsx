...
import { APP_NAME, EVENT, THEME, TITLE_TIMEOUT, VERSION_TIMEOUT } from "../src/constants";
import { loadFromBlob } from "../src/data/blob";
import { ExcalidrawElement, FileId, NonDeletedExcalidrawElement, Theme } from "../src/element/types";
import { useCallbackRefState } from "../src/hooks/useCallbackRefState";
import { t } from "../src/i18n";
import { Excalidraw, defaultLang, LiveCollaborationTrigger } from "../src/packages/excalidraw/index";
import {
	AppState,
	LibraryItems,
...
import { restore, restoreAppState, RestoredDataState } from "../src/data/restore";
...
import { parseLibraryTokensFromUrl, useHandleLibrary } from "../src/data/library";
...
const ExcalidrawWrapper = () => {
	...
	const [theme, setTheme] = useState<Theme>(
		() =>
			(localStorage.getItem(STORAGE_KEYS.LOCAL_STORAGE_THEME) as Theme | null) ||
	...
	const renderCustomStats = (elements: readonly NonDeletedExcalidrawElement[], appState: UIAppState) => {
		return (
			<CustomStats
	...
	return (
		...
		>
			...
			>
				...
				/>
				<AppWelcomeScreen setCollabDialogShown={setCollabDialogShown} isCollabEnabled={!isCollabDisabled} />
				...
				{isCollaborating && isOffline && (
					<div className="collab-offline-warning">{t("alerts.collabOfflineWarning")}</div>
				)}
				{latestShareableLink && (
					<ShareableLinkDialog
