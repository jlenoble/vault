...
export const rotate = (x1: number, y1: number, x2: number, y2: number, angle: number): [number, number] =>
...
export const rotatePoint = (point: Point, center: Point, angle: number): [number, number] =>
	rotate(point[0], point[1], center[0], center[1], angle);
...
export const isPointInPolygon = (points: Point[], x: number, y: number): boolean => {
...
export const getGridPoint = (x: number, y: number, gridSize: number | null): [number, number] => {
	if (gridSize) {
...
export const getPointsInBezierCurve = (element: NonDeleted<ExcalidrawLinearElement>, endPoint: Point) => {
...
export const getBezierCurveArcLengths = (element: NonDeleted<ExcalidrawLinearElement>, endPoint: Point) => {
...
export const getBezierCurveLength = (element: NonDeleted<ExcalidrawLinearElement>, endPoint: Point) => {
...
export const mapIntervalToBezierT = (
	...
	return (
		1 -
		(index + (targetLength - arcLengths[index]) / (arcLengths[index + 1] - arcLengths[index])) / pointsCount
	);
};
...
export const rangesOverlap = ([a0, a1]: [number, number], [b0, b1]: [number, number]) => {
	if (a0 <= b0) {
		return a1 >= b0;
	}
